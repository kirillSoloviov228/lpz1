...
class Program
{
    ...
    {
        var Person1 = new Person("Lisiy", "Soloviev", DateTime.Now);
        var Person2 = new Person("Nikita", "Smirnov", DateTime.Now);
        ...
        student.AddExams(new Exam("phisic", 3, date1), new Exam("OBJ", 5, date2));

        student2.AddExams(new Exam("math", 5, date1), new Exam("TRIZBD", 5, date2));
